...
begin
  ...
  { intro l,
    ...
    { intros _ _ _ h, simp only [formula_symbol_of_formula, bounded_formula.rec2_aux,
        bounded_formula.rec2, and_false] at h, simpa [h] },
    { intros _ _ r, apply hrel r },
    { intros _ _ _ _ _ h, simp only [formula_symbol_of_formula, bounded_formula.rec2_aux,
        bounded_formula.rec2, and_false] at h, simpa [h] },
    { intros _ _ _ h, simp only [formula_symbol_of_formula, bounded_formula.rec2_aux,
